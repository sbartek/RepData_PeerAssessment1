...
```{r}
ggplot()+
    geom_line(data=steps.total.per.day,aes(x=as.Date(date),y=steps.total.per.day.nona$total,color='black'))+
    geom_line(data=steps.total.per.day,aes(x=as.Date(date),y=total,color='red'))+
    xlab('Date')+ylab('Steps per day') + 
    scale_colour_manual(name = '', 
         values =c('black'='black','red'='red'), labels = c('NA removed','with NA'))
